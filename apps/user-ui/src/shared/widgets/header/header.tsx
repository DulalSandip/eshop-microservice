      ...
      <div className="w-[80%] py-5 m-auto flex items-center justify-between">
        ...
        <div className="w-[50%] relative ">
          <input
            ...
            className="w-full px-4 font-Poppins font-medium border-[2.5px] border-[#9348FF] outline-none h-[55px]"
          />
          ...
          <div className="flex items-center gap-2">
            {!isLoading && user ? (
              <>
                <Link
                  href={'/profile'}
                  className="border-2 w-[50px] h-[50px] flex items-center justify-center rounded-full border-[#ed0d0d1a]"
                >
                  <ProfileIcon />
                </Link>
